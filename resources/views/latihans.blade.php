  ...
  @endif
    ...
    <div class="card-body text-center">
      <h3 class="card-title"><a href="/latihans/{{ $latihans[0]->slug }}" 
        ...
        <p class="card-text">{!! $latihans[0]->soal !!}</p>

        {{-- <a href="/latihans/{{ $latihans[0]->slug }}" class="text-decoration-none btn btn-primary">Selanjutnya...</a> --}}
        <a href="/latihans/{{ $latihans[0]->slug }}" class="d-block mt-3 text-decoration-none text-light d-inline-flex p-2 rounded" 
        ...
        <div class="col-md-4 mb-3">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <p class="card-text">{!! $latih->soal !!}</p>
